...
from base_model.features import Features
import copy
...
def fit(epochs, model, loss, optimizer, train_loader,
        valid_loader=None, valid_df=None, notebook=False,
    ...
    for epoch in tqdm(range(epochs)):
        ...
        scores = roc_auc_score(valid_df['label'], preds.ravel())
        print('epoch:{}, auc:{}'.format(epoch, scores))
    return losses
