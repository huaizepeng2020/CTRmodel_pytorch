    ...
    def build_embeddings(
        ...
        for feature in itertools.chain(
            ...
            if feature.embedding_name not in embeddings:
                ...
                """"----bias-----"""
                embeddings[feature.embedding_name + '_bias'] = nn.Embedding(
                    feature.dimension(), 1, padding_idx=0)
                embedding_sizes[feature.embedding_name + '_bias'] = 1

                self.add_module(
                    f"embedding:{feature.embedding_name+ '_bias'}",
                    embeddings[feature.embedding_name+ '_bias'])
